...
public:
	...
	void printMemory(const Machine::State& m, uint16_t addr, uint16_t size);
	...
	void disassemble(const Machine::State& m, size_t opcodes, size_t ip);
...
private:
	CircularArray<uint16_t> m_ip_history;
